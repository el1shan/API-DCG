...
type DriftReportSpec struct {
	...
	// foo is an example field of DriftReport. Edit driftreport_types.go to remove/update
	// +optional
...
type DriftReportStatus struct {
	...
	// conditions represent the current state of the DriftReport resource.
...
type DriftReport struct {
	...
	// spec defines the desired state of DriftReport
	// +required
	Spec DriftReportSpec `json:"spec"`

	// status defines the observed state of DriftReport
	// +optional
	Status DriftReportStatus `json:"status,omitzero"`
}

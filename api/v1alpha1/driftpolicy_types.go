...
type DriftPolicyStatus struct {
	...
	// conditions represent the current state of the DriftPolicy resource.
...
type DriftPolicy struct {
	...
	// spec defines the desired state of DriftPolicy
	// +required
	Spec DriftPolicySpec `json:"spec"`

	// status defines the observed state of DriftPolicy
	// +optional
	Status DriftPolicyStatus `json:"status,omitzero"`
}
